...
class SourceFieldMappingHttpClient {
    constructor({
        endpoint,
        connectorId,
        credential,
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires endpoint"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires connectorId"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires credential"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires authorizationScheme"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires connectorIdHeader"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires positive timeoutMs"
            );
        }

        if (typeof fetchImpl !== "function") {
            throw new Error(
                "SourceFieldMappingHttpClient requires fetchImpl"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingHttpClient requires HTTPS endpoint"
            );
        }
    ...
    async ingest(sourceFieldMapping) {
        if (
            !sourceFieldMapping ||
            typeof sourceFieldMapping !== "object" ||
            Array.isArray(sourceFieldMapping)
        ) {
            throw new TypeError(
                "sourceFieldMapping is required"
            );
        }
        ...
        try {
            ...
            try {
                ...
                const error =
                    new Error(
                        "Server Trust Boundary source field mapping is unreachable"
                    );
            ...
            if (!response.ok) {
                ...
                const error =
                    new Error(
                        "Server Trust Boundary source field mapping request failed"
                    );
            ...
            try {
                ...
                const error =
                    new Error(
                        "Server Trust Boundary source field mapping returned invalid response"
                    );
