...
class SqliteSourceDocumentSyncStateStore {
    constructor({ databasePath } = {}) {
        ...
        this.database.exec(`
            CREATE TABLE IF NOT EXISTS source_document_raw_sync_states (
        ...
        const row =
            this.database.prepare(`
                SELECT
                    ...
                    next_retry_at,
                    last_error_code
                FROM source_document_raw_sync_states
    ...
    markAttempt({
        ...
        this.database.prepare(`
            INSERT INTO source_document_raw_sync_states (
                source_document_key,
                relative_path_lookup_key,
                status,
                last_attempt_at
        ...
        this.database.prepare(`
            ...
            DO UPDATE SET
                ...
                last_attempt_at =
                    excluded.last_attempt_at,
                failure_count =
                    source_document_raw_sync_states.failure_count + 1,
                next_retry_at =
...
module.exports = SqliteSourceDocumentSyncStateStore;
