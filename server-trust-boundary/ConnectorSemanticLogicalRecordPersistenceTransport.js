...
class ConnectorSemanticLogicalRecordPersistenceTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        ...
        if (!httpAdapter || typeof httpAdapter.handle !== "function") {
            throw new Error("ConnectorSemanticLogicalRecordPersistenceTransport requires httpAdapter");
        }
        ...
        if (
            ...
            throw new Error("ConnectorSemanticLogicalRecordPersistenceTransport requires credentialTransport");
        }
