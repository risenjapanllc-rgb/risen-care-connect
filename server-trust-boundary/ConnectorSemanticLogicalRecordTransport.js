...
class ConnectorSemanticLogicalRecordTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        ...
        if (!httpAdapter || typeof httpAdapter.handle !== "function") {
            throw new Error("ConnectorSemanticLogicalRecordTransport requires httpAdapter");
        }
        ...
        if (
            ...
            throw new Error("ConnectorSemanticLogicalRecordTransport requires credentialTransport");
        }
    ...
    async handle({
        ...
        if (
            ...
            [body.residentId, body.semanticType, body.logicalSlot]
                .some(
                    value =>
                        typeof value !== "string" ||
                        !value.trim()
        ...
        const result =
            await this.httpAdapter.handle({
                ...
                semanticType: body.semanticType.trim(),
                logicalSlot: body.logicalSlot.trim()
            });
