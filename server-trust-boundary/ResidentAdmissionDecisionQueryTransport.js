...
class ResidentAdmissionDecisionQueryTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        ...
        if (!httpAdapter || typeof httpAdapter.handle !== "function") {
            throw new Error("ResidentAdmissionDecisionQueryTransport requires httpAdapter");
        }
        if (!credentialTransport || typeof credentialTransport.extract !== "function") {
            throw new Error("ResidentAdmissionDecisionQueryTransport requires credentialTransport");
        }
...
module.exports = ResidentAdmissionDecisionQueryTransport;
