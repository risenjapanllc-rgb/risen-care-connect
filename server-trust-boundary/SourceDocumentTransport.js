...
class SourceDocumentTransport {
    constructor({
        ...
        if (
            ...
            throw new Error(
                "SourceDocumentTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceDocumentTransport requires credentialTransport"
            );
        }
