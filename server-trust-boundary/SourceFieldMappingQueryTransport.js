...
class SourceFieldMappingQueryTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        connectorIdHeader =
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingQueryTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingQueryTransport requires credentialTransport"
            );
        }
