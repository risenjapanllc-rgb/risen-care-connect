...
class SourceFieldMappingTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        connectorIdHeader =
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceFieldMappingTransport requires credentialTransport"
            );
        }
    ...
    async handle({
        ...
        if (
            ...
            envelopeKeys[0] !==
                "sourceFieldMapping" ||
            !body.sourceFieldMapping ||
            typeof body.sourceFieldMapping !==
                "object" ||
            Array.isArray(
                body.sourceFieldMapping
            )
