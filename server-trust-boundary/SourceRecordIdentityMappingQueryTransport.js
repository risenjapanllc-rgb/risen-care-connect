...
class SourceRecordIdentityMappingQueryTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        connectorIdHeader =
        ...
        if (
            ...
            throw new Error(
                "SourceRecordIdentityMappingQueryTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceRecordIdentityMappingQueryTransport requires credentialTransport"
            );
        }
