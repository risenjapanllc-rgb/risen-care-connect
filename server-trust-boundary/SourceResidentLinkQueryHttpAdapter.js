...
class SourceResidentLinkQueryHttpAdapter {
    constructor({
        queryService,
        diagnosticLogger
    } = {}) {
        if (
            ...
            throw new Error(
                "SourceResidentLinkQueryHttpAdapter requires queryService"
            );
        }
    ...
    async handle({
        ...
        try {
            ...
            this.diagnoseError(
                requestId,
                "source_resident_link_query_application_exception"
            );
        ...
        if (
            ...
            this.diagnoseError(
                requestId,
                "source_resident_link_query_result_invalid"
            );
        ...
        if (result.status === "error") {
            const internalErrorCode =
                ...
                result.errorCode.trim()
                    ? result.errorCode.trim()
                    : "source_resident_link_query_error";
