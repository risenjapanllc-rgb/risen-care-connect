...
class SourceResidentLinkQueryTransport {
    constructor({
        httpAdapter,
        credentialTransport,
        connectorIdHeader =
        ...
        if (
            ...
            throw new Error(
                "SourceResidentLinkQueryTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "SourceResidentLinkQueryTransport requires credentialTransport"
            );
        }
