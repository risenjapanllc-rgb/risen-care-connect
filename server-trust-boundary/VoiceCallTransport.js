...
class VoiceCallTransport {
    constructor({
        ...
        if (
            ...
            throw new Error(
                "VoiceCallTransport requires httpAdapter"
            );
        }
        ...
        if (
            ...
            throw new Error(
                "VoiceCallTransport requires credentialTransport"
            );
        }
    ...
    async handle({
        ...
        /*
         * facilityIdは意図的に受け取らない。
         *
         * 発信元施設はConnectorTrustServiceが
